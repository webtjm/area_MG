...
<div>
        ...
        <div class="foods-wrapper" ref="foodsWrapper">
              <ul> 
                  <li class="food-list food-list-hook" v-for="(item,index) in goods" :key="index">
                      ...
                      <ul>
                          <li @click="selectFood(food,$event)" class="food-item" v-for="(food,index) in item.foods" :key="index">
                              <div class="icon">
    ...
    <v-food :food="selectedFood" ref="foodDesc"></v-food>
</div>
    ...
    export default{
        ...
        methods:{
            ...
            selectFood(food,event){
                ...
                var foodDesc = this.$refs.foodDesc;
                foodDesc.show();
            }
        },
        mounted(){
